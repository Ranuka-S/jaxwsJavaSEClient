 ...
 * 
 */
@WebServiceClient(name = "HelloWorldImplService", targetNamespace = "http://webService.ranuka.com/", wsdlLocation = "http://localhost:8080/WS/HelloWorld?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWORLDIMPLSERVICE_QNAME = new QName("http://webService.ranuka.com/", "HelloWorldImplService");
    ...
    public HelloWorldImpl getHelloWorldImplPort() {
        return super.getPort(new QName("http://webService.ranuka.com/", "HelloWorldImplPort"), HelloWorldImpl.class);
    }
    ...
    public HelloWorldImpl getHelloWorldImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webService.ranuka.com/", "HelloWorldImplPort"), HelloWorldImpl.class, features);
    }
